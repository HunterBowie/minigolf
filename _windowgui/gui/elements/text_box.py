...
from _windowgui.constants import Color, EventType, RelativePosition
from _windowgui.gui.elements.gui_element import GUIElement
from _windowgui.util import Text, Timer
...
class TextBox(GUIElement):
    ...
    def process_input(self, key_name: str):
        ...
        match key_name:
            ...
            case "backspace":
                ...
                return
            case "return":
                self.post_event(EventType.TEXTBOX_POSTED,
                                data=self.text.string)
                return
            case "v":
    ...
    def update(self):
        self.text.center_y(pygame.Rect(
